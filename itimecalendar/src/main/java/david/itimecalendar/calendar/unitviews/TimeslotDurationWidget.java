...
public class TimeslotDurationWidget<T> extends FrameLayout{
    ...
    private void initViews(){
        ...
        label.setTextSize(DensityUtil.px2sp(context, labelTextSizePx));
    ...
    private void performShowAnimation(){
        ...
        // prepare anim data
        float targetTextSize = label.getTextSize()*1.5f;
        ...
        ValueAnimator textSizeAnimator = ValueAnimator.ofFloat(labelTextSizePx,targetTextSize);
    ...
    private void performHideAnimation(){
        ...
        ValueAnimator textSizeAnimator = ValueAnimator.ofFloat(label.getTextSize(), labelTextSizePx);
        textSizeAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                float newValue = (float) animation.getAnimatedValue();
